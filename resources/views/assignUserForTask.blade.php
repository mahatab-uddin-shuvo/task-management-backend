            ...
            <table role="presentation"
                ...
                <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                    <td align="left" style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                        <span style="font-weight: bold; padding-top: 10px;"> Task management </span>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="padding:0 0 36px 0;color:#153643;">
                                    ...
                                    <p
                                        ...
                                        This task <b>{{ $user ? $user['taskName'] : '' }}</b> has been assigned by <b>{{ $user ? $user['assigneeUserName'] : '' }}</b>.
                                    </p>
                                    <p
                                        style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                        Your Task deadline is: <b>{{ $user ? $user['taskDuration'] : '' }}</b>
                                    </p>
                                    <p
                                        style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                        Your Task description is: <b>{{ $user ? $user['taskDescription'] : '' }}</b>
                                    </p>
                                    <p
                                        style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                        Your Task Status is: <b>{{ $user ? $user['taskStatus'] : '' }}</b>
                                    </p>

                                    <p
                                        style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                        If you have any query, please send an email to: <b>{{ $user ? $user['assigneeUserEmail'] : '' }}</b>
                                    </p>
